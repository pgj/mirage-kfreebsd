...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_Double_val);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_Store_double_val);
#else
  union { value v[2]; double d; } buffer;
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_copy_double);
#else
  value res;
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_format_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_float_of_substring);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_float_of_string);
#else
  char parse_buffer[64];
  char * buf, * src, * dst, * end;
  mlsize_t len;
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_int_of_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_float_of_int);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_neg_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_abs_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_add_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_sub_float);
#else
  return caml_copy_double(Double_val(f) - Double_val(g));
#endif
}
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_mul_float);
#else
  return caml_copy_double(Double_val(f) * Double_val(g));
#endif
}
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_div_float);
#else
  return caml_copy_double(Double_val(f) / Double_val(g));
#endif
}
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_exp_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_floor_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_fmod_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_frexp_float);
#else
  CAMLparam1 (f);
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_ldexp_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_log_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_log10_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_modf_float);
#else
  double frem;
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_sqrt_floate);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_power_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_sin_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_sinh_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_cos_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_cosh_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_tan_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_tanh_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_asin_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_acos_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_atan_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_atan2_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_ceil_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_expm1_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_log1p_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_neq_float);
#else
  return Val_bool(Double_val(f) != Double_val(g));
#endif
}
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_float_compare);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED(caml_classify_float);
#else
...
{
#ifdef _KERNEL
  NOT_IMPLEMENTED_VOID(caml_init_ieee_floats);
#else
