...
#if defined(_KERNEL) && defined(__GNUC__) && defined(__i386__)

#define Read_and_clear(dst,src) \
  __asm__("xorl %0, %0; xchgl %0, %1" \
      : "=r" (dst), "=m" (src) \
      : "m" (src))

#elif defined(_KERNEL) && defined(__GNUC__) && (defined(__x86_64__) || defined(__amd64__))
